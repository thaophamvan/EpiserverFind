...
3. QueryBuilder: Dynamically tranform from input to expresstion which ITypeSearch can execute: 4 days
4. FacetRegistry: Can config dynamic facet and then tranform to expresstion which ITypeSearch can execute: 5 days
